...
def main(args):
    ...
    for f in tqdm(file_paths):
        try:
            seg_list, meta_list = segment_audio(f, **seg_dict)
        except:
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default="",
        help="Path to directory containing raw samples.",
    )
    parser.add_argument(
        "--output_dir",
        type=str,
        default="",
        help="Path to directory to save the cropped samples and metadata to.",
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.2,
        help="Percentage of files to be used for validation. Default is 0.2 (20%%)",
    )
    parser.add_argument(
        "--n_test",
        type=int,
        default=50,
        help="Number of files to be used for testing/generation. Default is 50",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=30,
        help="Duration of audio segments in seconds. Default is 30.",
    )
    parser.add_argument(
        "--cutoff",
        type=str,
